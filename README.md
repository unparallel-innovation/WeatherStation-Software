...
After having successfully connected your LoPy4 board to Atom or VS Code, click the upload button on the bottom to program you LoPy4 with this weather station software.

For more details and information check the [pycom getting started](https://docs.pycom.io/gettingstarted/).
